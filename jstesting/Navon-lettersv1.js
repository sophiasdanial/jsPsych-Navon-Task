...
//Set up post task questionnaire (may delete)
var post_task_block = {
   type: 'survey-text',
   data: {
...
var feedback_instruct_text =
  'Welcome to Part Three of the experiment. Press <strong>enter</strong> to begin.'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p align="center">This is a <strong>timed</strong> activity. Please try to be as <strong>fast</strong> and <strong>accurate</strong> as possible</div>',
    '<div class = centerbox><p align="center">Similar to Part One, each trial will present a large letter made out of smaller letters.<br><br>For example, you may see a large `H` made out of smaller `S`s. Or you may see a large `S` made out of smaller `H`s.<br><br>You will be asked to identify either the large letter or the smaller letter. </p></div>',
...
/* define practice block - Contains FEEDBACK */
var practice_block = {
